...
function checkNewStudies() {
    ...
    for (const study of studyList) {
        ...
        const researcher = (_f = (_e = study.querySelector('[data-testid="host"]')) === null || _e === void 0 ? void 0 : _e.textContent) === null || _f === void 0 ? void 0 : _f.split(' ').slice(1).join(' ');
...
chrome.tabs.onUpdated.addListener((_a, _b, tab) => __awaiter(void 0, void 0, void 0, function* () {
    if (tab.id && tab.url && tab.url.includes('https://app.prolific.com') && tab.status === 'complete') {
        ...
        audio = shouldPlayAudio ? yield getValueFromStorage(AUDIO, 'alert1.mp3') : null;
        volume = shouldPlayAudio ? (yield getValueFromStorage(VOLUME, 100)) / 100 : null;
        ...
        chrome.scripting.executeScript({
            ...
            if (results && results[0] && results[0].result) {
                const studies = results[0].result;
